                        ...
                        <div class="latest-product__text">
                            ...
                            <div class="latest-product__slider owl-carousel">
                                <div class="latest-prdouct__slider__item">
                                	...
                                	for(DataActividad da : acts){
                                	%>
                                		<a href="consulta_actividad_Visitante.html" class="latest-product__item">
                                        <div class="latest-product__item__pic">
                                            <img src="../img/degusta.jpg" alt="">
                                        </div>
                                        <div class="latest-product__item__text">
                                            <h5> <%= da.getNombre() %> </h5>
                                            <h6> <%= da.getDescripcion() %> </h6>
                                            <span href="consulta_actividad_Visitante.html" class="blog__btn" >LEER MÁS </span>
                                        </div>
                                    </a>
                                	<% } %>
                                </div>
