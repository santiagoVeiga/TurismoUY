...
<%@page import="servidor.DataUsuario,servidor.DataDepartamento,servidor.DataTurista,servidor.DataProveedor,servidor.DataSalida,java.util.Set,controllers.EstadoSesion,servidor.DataPaquete,servidor.DataActividad" %>
...
<!-- Page Preloder -->
                            ...
                            <form method="post"class="needs-validation" enctype="multipart/form-data"  action="/tarea2p2/SalidaCreada?actividadSal=<%=actNombre%>" id="sell-info">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="salidaNombre" name="salidaNombre" onkeyup="salDisp()" required placeholder="" value="" >
                                        <div >
						              	<p id="checkNom"> </p>
						              </div>
	                                ...
	                                <hr class="mb-4">
	                                    <div class="col-md-12 order-md-1">
	                                        ...
	                                        <div class=" " id="file-upload">
	                                            <input type="file" accept="image/jpg, image/jpeg"class="form-control" id="salidaFotos" name="salidaFotos" />
	                                        </div>
	                                    </div>
	                                <hr class="mb-4">
	                                <br>
	...
	function salDisp() {
		  ...
		  xhttp.open("GET", "/tarea2p2/perteneceSal?sal="+document.getElementById("salidaNombre").value, true);
		  xhttp.send();
		}
	</script>
</body>
