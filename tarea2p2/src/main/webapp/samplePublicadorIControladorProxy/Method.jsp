...
<LI><A HREF="Input.jsp?method=10" TARGET="inputs"> getPublicadorIControlador()</A></LI>
<LI><A HREF="Input.jsp?method=17" TARGET="inputs"> getFile(java.lang.String)</A></LI>
<LI><A HREF="Input.jsp?method=22" TARGET="inputs"> dataDepartamentoNull()</A></LI>
<LI><A HREF="Input.jsp?method=31" TARGET="inputs"> dataTuristaNull()</A></LI>
<LI><A HREF="Input.jsp?method=34" TARGET="inputs"> dataProveedorNull()</A></LI>
<LI><A HREF="Input.jsp?method=37" TARGET="inputs"> dataActividadNull()</A></LI>
<LI><A HREF="Input.jsp?method=56" TARGET="inputs"> dataCGNull()</A></LI>
<LI><A HREF="Input.jsp?method=83" TARGET="inputs"> dataCPNull()</A></LI>
<LI><A HREF="Input.jsp?method=110" TARGET="inputs"> estadoActNull()</A></LI>
<LI><A HREF="Input.jsp?method=115" TARGET="inputs"> verInfoUsuario(java.lang.String)</A></LI>
<LI><A HREF="Input.jsp?method=134" TARGET="inputs"> getUsuariosComp()</A></LI>
<LI><A HREF="Input.jsp?method=137" TARGET="inputs"> ingresarDatos(java.lang.String)</A></LI>
<LI><A HREF="Input.jsp?method=156" TARGET="inputs"> obtenerActividadCategoria(java.lang.String)</A></LI>
<LI><A HREF="Input.jsp?method=161" TARGET="inputs"> obtenerDataUsuarioNick(java.lang.String)</A></LI>
<LI><A HREF="Input.jsp?method=180" TARGET="inputs"> obtenerDataUsuarioMail(java.lang.String)</A></LI>
<LI><A HREF="Input.jsp?method=199" TARGET="inputs"> obtenerDataActividad(java.lang.String)</A></LI>
<LI><A HREF="Input.jsp?method=220" TARGET="inputs"> obtenerDataSalida(java.lang.String)</A></LI>
<LI><A HREF="Input.jsp?method=239" TARGET="inputs"> comprarPaquete(java.lang.String,java.util.Calendar,int,java.lang.String)</A></LI>
<LI><A HREF="Input.jsp?method=250" TARGET="inputs"> inscribirPaq(java.lang.String,java.lang.String,int,java.util.Calendar,java.lang.String,java.lang.String)</A></LI>
<LI><A HREF="Input.jsp?method=265" TARGET="inputs"> obtenerPaquetesComprados(java.lang.String)</A></LI>
<LI><A HREF="Input.jsp?method=270" TARGET="inputs"> obtenerNomActPorSalida(java.lang.String)</A></LI>
<LI><A HREF="Input.jsp?method=275" TARGET="inputs"> selecDepartamento(java.lang.String)</A></LI>
